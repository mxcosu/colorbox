...
##### Version 1.6.5 - 2016/05/10

* Fixed an accessibility false flag bug for Drupal. Where the empty buttons get rendered and accessibility tools report and error due to the empty buttons.
